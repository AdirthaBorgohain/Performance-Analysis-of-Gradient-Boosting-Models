...
XGBclassifier = XGBClassifier(n_jobs =-1, tree_method='hist', learning_rate=0.05, max_depth=10, min_child_weight=3, n_estimators=800)
...
# Fitting XGBoost to the Training set
XGBclassifier_gpu = XGBClassifier(n_jobs=-1, tree_method='gpu_hist', learning_rate=0.05, max_depth=10, min_child_weight=3, n_estimators=800)
...
LGBclassifier = LGBMClassifier(objective='multiclass', device='cpu', learning_rate=0.03, metric='multi_logloss', max_depth=25, n_estimators=800, num_leaves=100)
...
## ----------------------------------------------------------------  GPU
LGBclassifier_gpu = LGBMClassifier(objective='multiclass', device='gpu', learning_rate=0.03, metric='multi_logloss', max_depth=25, n_estimators=800, num_leaves=100)
...
CBclassifier_gpu = CatBoostClassifier(loss_function='MultiClass',task_type='GPU', learning_rate=0.1, depth=10, l2_leaf_reg=1, iterations=500)
