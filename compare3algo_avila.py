...
XGBclassifier = XGBClassifier(n_jobs = -1, tree_method='hist', learning_rate=0.1, max_depth=10, min_child_weight=1, n_estimators=500)
...
# Fitting XGBoost to the Training set
XGBclassifier_gpu = XGBClassifier(n_jobs = -1, tree_method='gpu_hist', learning_rate=0.1, max_depth=10, min_child_weight=1, n_estimators=500)
...
LGBclassifier = LGBMClassifier(objective = 'multiclass', device = 'cpu', learning_rate = 0.05, metric = 'multi_logloss', max_depth = 50, n_estimators = 500, num_leaves = 300)
...
## ----------------------------------------------------------------  GPU
LGBclassifier_gpu = LGBMClassifier(objective = 'multiclass', device = 'gpu', learning_rate = 0.05, metric = 'multi_logloss', max_depth = 50, n_estimators = 500, num_leaves = 300)
